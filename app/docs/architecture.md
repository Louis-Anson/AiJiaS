...
│  │ Redis :6379                                      │      │
│  │ Donetick / Mealie / ezBookkeeping / Homebox / Immich   │      │
...
```text
  ...
  -> Donetick / Mealie / ezBookkeeping / Homebox (Docker)
...
| 类型 | 服务 | 策略 |
| :--- | :--- | :--- |
| 家庭子系统 | Donetick、Mealie、ezBookkeeping、Homebox、Immich、Navidrome | 直接使用上游镜像，默认只在内网暴露。 |
...
```text
2. 启动家庭子系统：Donetick / Mealie / ezBookkeeping / Homebox / Immich / Navidrome / Vaultwarden
