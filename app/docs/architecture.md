...
> 2026.06 当前主线：Hermes Agent（LXD 容器）原生支持企业微信/微信/飞书 Gateway，无需自建 AI Assistant Gateway 和 Service Adapter。
> Traefik 负责 HTTPS 入口 → 路由到各服务的域名。
n## AiJiaS 当前架构
