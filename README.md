...
- **服务翻译层**：Service Adapter 把 Donetick、Mealie/Tandoor、Homebox、Home Assistant 等服务整理成稳定好用的家庭能力。
- **家庭记忆库**：PostgreSQL 保存业务记录、交互过程、健康时间线和技能演化历史；敏感数据默认留在家里。
- **智能家居**：Home Assistant OS 运行在 NAS 虚拟机里，负责真正连接空调、洗衣机、门锁和各种传感器。

## 🫶 Family Care Engine

AiJiaS 不只是一个家庭事务管理器，它更像一个会照顾关系与状态的家庭引擎。它会关心每个家庭成员的负担、情绪、睡眠、经期、疲惫程度和近期压力，尽量在事情变得太多、太累、太乱之前，先发出温柔而及时的提醒。

它关注的不只是“事情有没有完成”，还关注“这个家现在平不平衡”。当一方工作太忙、状态很差、心情烦躁，系统会提醒另一方分担和安抚；当一方操心太多、睡眠不好、临近生理期，系统也会主动提示减负、休息和调整节奏。

Family Care Engine 的目标不是替代家人，而是帮助家人更好地看见彼此、照顾彼此，让这个家保持温暖、柔软和有爱意的节奏。

## 🧭 为什么选择 Hermes

旧的双 Agent 试用路线已不再保留。当前方向是：**用 Hermes 做一个更像“长期家庭管家”的核心 AI**。
